...
Every game has an illustration, and every one is **drawn rather than
collected**:

<p align="center">
  <img src="assets/games/xiangqi.svg" width="270" alt="Xiangqi">
  <img src="assets/games/catan.svg" width="270" alt="Catan">
  <img src="assets/games/uno.svg" width="270" alt="Uno">
</p>

The obvious way to show somebody a game is a photo of the box. Every one of
those is copyrighted — and a project that refuses to paste a publisher's *words*
would be drawing a strange line by pasting their *photographs*.
...
photograph"*, and generated by [`lib/art.mjs`](lib/art.mjs) so a new game gets
one for free.
...
| | |
|---|---|
| **[Lichess](https://lichess.org)** | Chess. Free, open source, funded by donations, no advertising |
| **[PlayOK](https://www.playok.com/en/xiangqi/)** | Xiangqi, backgammon, cribbage, ludo — no account needed |
| **[cardgames.io](https://cardgames.io/hearts/)** | Hearts, spades, gin rummy, Go Fish, Yahtzee, crazy eights |
| **[Board Game Arena](https://boardgamearena.com)** | Jaipur, 7 Wonders Duel, Azul, Hive, Patchwork |
| **[codenames.game](https://codenames.game)** | Codenames, no account, share one link |
| **[Woogles](https://woogles.io/)** | The crossword game, free and open source |

Every link was checked before being added, and the monthly rot job checks them
alongside the sources — a dead play link wastes somebody's evening.
...
<details>
<summary><b>All 37 games</b> — who they suit, what they really take, and how many arguments each one starts</summary>
...
| **[Xiangqi](docs/games/xiangqi.md)** | 2–2 (best 2) | 30 min | **35 min** | 10 min | ●●●○○ | 0% | 7 |
...
<details>
<summary><b>All 203 rulings</b> — every argument in the registry, official or not</summary>
...
| [Xiangqi](docs/games/xiangqi.md) | Can the two generals face each other down an open file? | ✅ yes | near universal |
| [Xiangqi](docs/games/xiangqi.md) | Is stalemate a draw? | ✅ yes | near universal |
| [Xiangqi](docs/games/xiangqi.md) | Does the horse jump like a knight? | ✅ yes | near universal |
| [Xiangqi](docs/games/xiangqi.md) | How exactly does the cannon capture? | ✅ yes | near universal |
| [Xiangqi](docs/games/xiangqi.md) | Can you draw by repeating check forever? | ✅ yes | common |
| [Xiangqi](docs/games/xiangqi.md) | Can the elephant cross the river? | ✅ yes | near universal |
| [Xiangqi](docs/games/xiangqi.md) | When can a soldier move sideways? | ✅ yes | common |
...
203 rulings on file. [Add the one your table argues about](https://github.com/mohitagw15856/rulebook/issues/new?template=good-first-ruling.yml) — it is one entry, no code, and no build step.
